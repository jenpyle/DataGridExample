...
namespace DataGridAnimation
{
    ...
    public static class EnumerableExtensions
    {
        ...
        public static IEnumerable<T> ToEmptyIfNull<T>(this IEnumerable<T> @this)
        {
        ...
        public static IEnumerable<T> ThrowIfEmpty<T>(this IEnumerable<T> @this, string propertyName)
        {
            return ThrowIfEmpty(
                @this,
                exceptionFactory: () => new ArgumentException($"{propertyName} cannot be empty"));
        }

        public static IEnumerable<T> ThrowIfEmpty<T>(this IEnumerable<T> @this, Func<Exception> exceptionFactory)
        {
            if (@this.Count() == 0)
            {
